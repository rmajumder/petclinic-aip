...
cd ~/Documents/aip/repository/petclinic-aip/spring-petclinic-visit
...
cd ~/Documents/aip/repository/petclinic-aip/spring-petclinic-vet
mvn clean package -Dmaven.test.skip=true
...
cd ~/Documents/aip/repository/petclinic-aip/spring-petclinic-pet
mvn clean package -Dmaven.test.skip=true
...
cd ~/Documents/aip/repository/petclinic-aip/spring-petclinic-owner
mvn clean package -Dmaven.test.skip=true
